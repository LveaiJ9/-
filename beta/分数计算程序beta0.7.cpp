...
int main(){
    ...
    int e_t=0,t_c=0,au=0,s_au=0,h_c=0,t_l=0,n_a_f=0,co=0,r_a=0,kl=0,w_m=0;//紧急授课，思维矫正，朝谒，灵魂朝谒，圣城，受法，不容拒绝，思维混乱，滚动先祖，奎龙，无漏
    while(true){
        ...
        switch(o0){
            case 1:{
                ...
                while(true){
                    ...
                    if(o1=='0') break;
                    else end=e_t+t_c+au+s_au+h_c+t_l+n_a_f;
                    if(((e_t!=0||t_c!=0)||(au!=0||s_au!=0))&&(h_c!=0||t_l!=0)){
                        cout<<"\033[2J\033[1;1H";
                        end=end+150;
                        int o01;
                        cout<<"首页/关卡结局\n同时达成两种结局（+150）\n0.返回上一级\n选项：";
                    ...
                    if(((e_t!=0||t_c!=0)||(au!=0||s_au!=0))&&(h_c!=0||t_l!=0)&&n_a_f!=0){
                        cout<<"\033[2J\033[1;1H";
                        end=end+200;
                        int o01;
                        cout<<"首页/关卡结局\n同时达成三种结局（+200）\n0.返回上一级\n选项：";
            ...
            case 7:{
                cout<<"\033[2J\033[1;1H";
                cout<<"首页/总分计算\n关卡结局：";
                if(e_t!=0) cout<<" 紧急授课+"<<e_t;
                if(t_c!=0) cout<<" 思维矫正+"<<t_c;
                if(au!=0) cout<<" 朝谒+"<<au;
                if(s_au!=0) cout<<" 灵魂朝谒+"<<s_au;
                if(h_c!=0) cout<<" 圣城+"<<h_c;
                if(t_l!=0) cout<<" 受法+"<<t_l;
                if(n_a_f!=0) cout<<" 不容拒绝+"<<n_a_f;
                if(((e_t!=0||t_c!=0)||(au!=0||s_au!=0))&&(h_c!=0||t_l!=0)&&n_a_f!=0) cout<<"同时达成三种结局+200";
                else if(((e_t!=0||t_c!=0)||(au!=0||s_au!=0))&&(h_c!=0||t_l!=0)) cout<<"同时达成两种结局+150";
                else cout<<"没有同时达成结局+0";
                cout<<"\n紧急作战：";
                if (o2 == "E") cout << "混沌";
                if (o2 == "A1") cout << "神出鬼没";
                if (o2 == "A2") cout << "神出鬼没·无漏";
                if (o2 == "B1") cout << "争议频发";
                if (o2 == "B2") cout << "争议频发·无漏";
                if (o2 == "C1") cout << "建制";
                if (o2 == "C2") cout << "建制·无漏";
                if (o2 == "D1") cout << "莱茵卫士";
                if (o2 == "D2") cout << "莱茵卫士·无漏";
                if (o2 == "F") cout << "神圣的渴求";
                if (o2 == "G") cout << "谋求共识";
                if (o2 == "H") cout << "“外道”";
                if (o2 == "I") cout << "洞天福地";
